...
class PedidoSerializer(serializers.ModelSerializer):
    idUsuarioComprador = serializers.IntegerField(source = "usuarioComprador.idUsuario")
    idUsuarioVendedor = serializers.IntegerField(source = "usuarioVendedor.idUsuario")
    class Meta:
        model = Pedido
